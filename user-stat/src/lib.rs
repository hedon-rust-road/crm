...
#[tonic::async_trait]
impl pb::user_stats_server::UserStats for UserStatsService {
...
pub mod test_utils {
    ...
    use crate::{
        ...
        UserStatsService, UserStatsServiceInner,
    };

    impl UserStatsService {
        pub async fn new_for_test() -> anyhow::Result<(TestPg, Self)> {
    ...
    pub async fn get_test_pool(url: Option<&str>) -> (TestPg, PgPool) {
        ...
        ts.commit().await.expect("execute sql failed");
